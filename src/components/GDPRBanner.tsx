...
export const GDPRBanner: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[1000] flex flex-wrap items-center justify-between gap-4 bg-gray-900 p-6 text-white shadow-2xl">
      ...
      <button 
        ...
        className="shrink-0 rounded-lg bg-indigo-600 px-6 py-2.5 font-medium text-white transition hover:bg-indigo-500"
      >
        Accept
      </button>
    </div>
