...
export const SearchSection: React.FC<SearchSectionProps> = ({ searchState, savedJobs, onSaveToggle }) => {
  const { loading, error, results, total, hasSearched } = searchState;

  return (
    <div id="search" className="flex-1">
      ...
      {loading ? (
        ...
        <div className="rounded-xl bg-white p-16 text-center text-gray-500 shadow-sm ring-1 ring-gray-100">
