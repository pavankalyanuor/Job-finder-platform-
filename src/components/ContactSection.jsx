...
export const ContactSection = () => {
    ...
    return (<section id="contact" className="bg-gray-50 py-16 md:py-24">
      <div className="mx-auto w-full max-w-[700px] px-6">
        <div className="rounded-2xl bg-white p-8 shadow-md md:p-12">
          ...
          {success ? (<div className="mb-8 rounded-lg bg-emerald-50 p-4 text-emerald-800 ring-1 ring-emerald-200">
              ...
              <div className="mb-6">
                ...
                <input type="text" id="contact-name" name="name" value={formData.name} onChange={handleInput} className={`w-full rounded-lg border p-3 focus:outline-none focus:ring-2 focus:ring-indigo-600/20 ${errors.name ? 'border-red-500' : 'border-gray-300 focus:border-indigo-600'}`} placeholder="E.g., Jane Doe"/>
              ...
              <div className="mb-6">
                ...
                <input type="email" id="contact-email" name="email" value={formData.email} onChange={handleInput} className={`w-full rounded-lg border p-3 focus:outline-none focus:ring-2 focus:ring-indigo-600/20 ${errors.email ? 'border-red-500' : 'border-gray-300 focus:border-indigo-600'}`} placeholder="jane@example.com"/>
              ...
              <div className="mb-6">
                ...
                <select id="contact-topic" name="topic" value={formData.topic} onChange={handleInput} className="w-full rounded-lg border border-gray-300 p-3 focus:border-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-600/20">
              ...
              <div className="mb-6">
                ...
                <textarea id="contact-message" name="message" rows={5} value={formData.message} onChange={handleInput} className={`w-full rounded-lg border p-3 focus:outline-none focus:ring-2 focus:ring-indigo-600/20 ${errors.message ? 'border-red-500' : 'border-gray-300 focus:border-indigo-600'}`} placeholder="How can we help?"></textarea>
                {errors.message && <span className="mt-1 block text-sm text-red-500">Message must be at least 10 characters long.</span>}
              </div>

              <div className="mb-8">
                <label className="flex cursor-pointer items-start gap-3">
                  <input type="checkbox" id="contact-consent" name="consent" checked={formData.consent} onChange={handleInput} className="mt-1 h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600"/>
